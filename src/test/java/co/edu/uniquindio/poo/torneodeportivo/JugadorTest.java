...
public class JugadorTest {
    ...
    public void registrarJugadorEquipo() {
        ...
        Jugador jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",LocalDate.now().minusYears(15),GeneroJugador.FEMENINO);
    ...
    public void registrarJugadorTorneo() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL,GeneroTorneo.MIXTO);
    ...
    public void registrarJugadorTorneoSinLimiteEdad() {
        ...
        var representante = new Persona("Robinson", "Pulgarin", "rpulgarin@email.com", "6067359300");
        var equipo = new Equipo("Uniquindio", representante);
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",LocalDate.now().minusYears(21),GeneroJugador.FEMENINO);
    ...
    public void registrarJugadorTorneoConLimiteEdad() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL,GeneroTorneo.MASCULINO);
    ...
    public void registrarJugadorTorneoInscripcionesCerradas() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(1), (byte)24, (byte)18, 0,TipoTorneo.LOCAL,GeneroTorneo.MASCULINO);
    ...
    public void registrarJugadoresRepetidosTorneo() {
        ...
        var torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL,GeneroTorneo.FEMENINO);
        ...
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",LocalDate.now().minusYears(15),GeneroJugador.FEMENINO);
        var jugador2 = new Jugador("Christian", "Candela", "ccandela@email.com", "6067431235",LocalDate.now().minusYears(15),GeneroJugador.FEMENINO);
